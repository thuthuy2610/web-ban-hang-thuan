<?php 
    ...
    if (isset($_GET['page'])) {
     ...
     $category = $db->fetchJone("category",$sql,$p,3,true);
...
<?php require_once __DIR__. "/../../layouts/header.php"; ?>
    ...
    <?php if(isset($_SESSION['erroredit'])){ ?>
    	<div class="alert alert-danger">
    		<?php echo $_SESSION['erroredit']; unset($_SESSION['erroredit']); ?>
    	</div>
    <?php } ?>
</div>
                  ...
                  <thead>
                     <tr role="row">
                       <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 54px;">STT</th>
                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 254px;">Name</th>
						            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending" style="width: 54px;">Slug</th>
